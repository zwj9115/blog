/*! TenVideoPlayer_V2 - v2.0.0 - 2016-06-02 17:24:38
 * Copyright (c) 2016
...
!function (a) {
    if (function (a) {
        ...
        }(jQuery), tvp = {}, tvp.lastModify = "2016-06-02 17:24:38", tvp.ts = tvp.lastModify.replace(/\D/g, ""), tvp.ver = "$V2.0Build7802$", tvp.dataset = {openLazy: !0}, tvp.name = "\u817e\u8baf\u89c6\u9891\u7edf\u4e00\u64ad\u653e\u5668", "undefined" == typeof window.DEBUG && (window.DEBUG = 1), window.FILEPATH = "//imgcache.qq.com/tencentvideo_v1/tvp/js/", top != window)try {
    ...
    "undefined" != typeof Zepto && Zepto._tvp ? (tvp.$ = Zepto, c = !0) : (tvp.$ = {}, c = !1), function () {
        ...
        isUseHtml5: function () {
            ...
            var a = "";
            return /(.*\.)3g\.qq\.com$/i.test(document.location.hostname) ? a = 13 : tvp.$.browser.qqlive ? a = 0 : /(.*\.)?v\.qq\.com$/i.test(document.location.hostname) ? a = 0 : tvp.$.browser.WeChat ? a = 3 : tvp.$.browser.MQQClient ? a = 10 : tvp.$.browser.qqnews && (a = 2), a
        ...
        var c, d = "0.0.0.0", f = "0.0.0", g = new Image, h = !1, i = !1;
        return "film.qq.com" == document.location.host && (i = !0), {
            getOcx: function (b) {
                if (tvp.$.isUndefined(b) && (b = !0), b && "0.0.0.0" != d)return d;
                var f;
                if (tvp.$.browser.ie)try {
                    f = "IE begin", c = new ActiveXObject(e.config.PROGID_QQLIVE_INSTALLER), "undefined" != typeof c.getVersion ? (d = c.GetVersionByClsid(e.config.OCX_CLSID), f = "get actObj.GetVersionByClsid:" + d) : f = "no function:actObj.GetVersionByClsid"
                } catch (j) {
                    ...
                    if (tvp.$.isUndefined(l.namedItem) || (f = "plugs.namedItem", k = l.namedItem("\u817e\u8baf\u89c6\u9891")), !k) {
                        f = "no plugs.namedItem:tencentvideo";
        ...
        rcmdTextReport: function (a, b, c, d) {
            var e, f, g, h, i, j;
            d = d || 0, g = window.navigator.userAgent.toLowerCase(), f = g.indexOf("qzone") > -1, i = tvp.app.pageType, j = tvp.common.getUin(), h = 1 === i ? 2 : 2 === i ? 4 : f ? 6 : -1, e = {
                oper: a,
                iplat: h,
                tab: b,
                rlist: c,
    ...
    d.ha = function (a) {
        ...
        function j(e) {
            ...
            if ("object" == typeof d && "function" == typeof d.$xx && "string" == typeof e) {
                ...
                k && (i = i + "&_qv_rmt=" + k.u1, i = i + "&_qv_rmt2=" + k.u2, b.getUrlParam("sdtfrom", e) || (i = i + "&sdtfrom=" + h), e = e + (-1 == e.indexOf("?") ? "?" : "&") + i, b.cookie.set("qv_als", k.c))
            }
            return e
        }
        ...
        k.cgi = function () {
            ...
            loadVideoUrlByVid: function (c) {
                ...
                }, d.retryDefer && b.isFunction(d.retryDefer.reject) && (t = !0, q = d.retryDefer, u = k.retryCgi.getinfo, z = k.retryCgi.getkey), d.loadingAdCgi && (u = d.loadingAdCgi, d.noAuth = !0), d.defer && (q = d.defer), y = i({
                    itype: 1,
                    val2: t ? 1 : 0,
                    str3: x,
                    vid: n.vid,
                ...
                var A = function (e) {
                    ...
                    var h, k = l.ul.ui[0];
                    o.br = l.br, o.path = k.url, o.fn = l.fn, o.fiid = e(n, f.fl.fi), o.vt = k.vt, h = new a.RetCode(100127), h.begin(), v = b.now(), x = z + b.param({
                            otype: "json",
                            vid: n.vid,
                            format: o.fiid,
                            filename: o.fn,
                    ...
                    x = u + b.param(r), f && "object" === b.type(f) && (x += "&" + b.param(f)), x = j(x), b.ajax({
                        url: x,
                        dataType: "jsonp",
                        jsonpCallback: "tvp_request_getinfo_callback_" + parseInt(1e6 * Math.random())
                    }).done(function (b) {
                        return !d.noAuth && b && 0 != b.em && "o" != b.s ? 85 === b.em && -3 === b.type && 1 === d.cgi_auth_index ? (d.cgi_auth_index += 1, d.defer = q, d.needTime = !0, d.svr_time = b.curTime, void a.h5Helper.loadVideoUrlByVid(d)) : (d.noAuth = !0, d.defer = q, void a.h5Helper.loadVideoUrlByVid(d)) : void A(b)
                    }).fail(function () {
        ...
        }, d = navigator.userAgent.toLowerCase(), e = {isqqlive: d.indexOf("qqlive") > -1}, f = {qqloginHash: "txvlogin_qqlogin_hash=1"}, g = function () {
            function a() {
                for (var a; a = d.shift();)a(b)
            }

            var b = !0, d = [];
            return location.href.indexOf(f.qqloginHash) > -1 && (b = !1, c.ajax({
                url: "//video.qq.com/fcgi-bin/qq_login",
                dataType: "jsonp"
            }, function () {
                location.href = location.href.replace(f.qqloginHash), b = !0, a()
            }, function () {
                b = !0, a()
            })), function (a) {
                b ? a(b) : d.push(a)
        ...
        a.prototype = {
            isLogin: function (a) {
                ...
                this.isLogin(function (c, d) {
                    return 0 === c ? void a({error: "not login"}) : e.isqqlive ? void b.tvGetUserInfo(["qq", "wx"], function (b) {
                        var d, e;
                        try {
                            d = JSON.parse(b)
                        } catch (f) {
                        }
                        return d ? (1 === c ? e = "qq" : 2 === c && (e = "wx"), void a(d && d.result && d.result[e] && d.result[e].nickname ? {
                            nick: d.result[e].nickname,
                            face: d.result[e].headImgUrl,
                            type: e
                        } : {error: "get tv " + e + " user info fail"})) : void a({error: "parse tv cookie fail"})
                    }) : void(1 === c ? b.requestQQInfo(function (b) {
                        a(b && b.nick ? {nick: b.nick, face: b.qqface, type: "qq"} : {error: "requestQQInfo fail"})
                    }) : 2 === c && a(d && d.nick ? {
                        nick: decodeURIComponent(d.nick),
                        face: d.head,
                        type: "wx"
                ...
                var b = this;
                g(function () {
                    var c = "//video.qq.com/getcookie/getcookie.html.html";
                    if ("qq.com" !== document.domain && a({error: "document.domain\u4e0d\u7b49\u4e8eqq.com\uff0c\u8de8\u57df\u5931\u8d25"}), b.cache.wxAuthCache)return void a(b.cache.wxAuthCache);
                    var d = document.createElement("iframe");
                    d.src = c, d.id = "tvp_login_cross_domin_frame", d.style.display = "none", b.wxCallbacks.push(a), window.txvGetLoginCookiesCallback = function (a) {
                        if (b.cache.wxAuthCache = a, b.wxCallbacks && b.wxCallbacks.length)for (var c; b.wxCallbacks.length;)c = b.wxCallbacks.shift(), "function" == typeof c && c.call(b, a)
                ...
                var b = "//video.qq.com/fcgi-bin/check_login", d = c.ajax({
                    url: b,
                    timeout: 5e3,
                    dataType: "jsonp"
                }, function (b) {
    ...
    var e = e || {
            ver: "$Rev: 125046 $",
            curSSO: "",
            lastmodify: "$Date: 2016-06-02 17:27:46 +0800 (Thu, 02 Jun 2016) $"
        };
    e.log = tvp.log, e.debug = function (a) {
        var b = "";
        if (a.indexOf("[") < 0 && arguments && arguments.callee && arguments.callee.caller) {
            var c = arguments.callee.caller;
            b = e.debug.getFunName(c)
        }
        a = b ? "[" + b + "]:" + a : a, -1 === tvp.log.isDebug && (tvp.log.isDebug = "true" == tvp.$.getUrlParam("debug") ? 1 : 0), tvp.log.isDebug && ("undefined" != typeof __TenVideo_OCX_CTRL_PAGE__ ? e.driverPage.sendMsg(e.DEFINE.MSG.DRVPG_EVT_DEBUGLOG, encodeURIComponent(a)) : tvp.log(a))
    }, e.debug.getFunName = function (a) {
        ...
        function a(a) {
            if (e.version.checkVerFormatValid(a))return a;
            if (/\d+/i.test(a)) {
        ...
        return _version = {}, {
            compare: function (b, c) {
                ...
                if (b = b || e.version.getSupportMinVersion(), !e.version.checkVerFormatValid(b))return !1;
                var c, d = e.version.get();
                return c = /^\d+$/.test(d) ? a(d) : d + "", e.version.compare(c, b) < 0 ? !1 : !0
            }, isZero: function (a) {
                return a = a || e.version.get(), /^\d+$/.test(a) && 0 == a ? !0 : 0 == e.version.compare(a, "0.0.0.0")
            }, checkVerFormatValid: function (a) {
                return /^(\d+\.){2}\d+(\.\d+)?$/.test(a)
            }, hasQQLiveOcx: function () {
                if (-1 != d)return 1 == d;
                var a = e.version.check();
                return d = a ? 1 : 0
            }, hasOldVersion: function () {
                if (-1 != c)return 1 == c;
                var a = e.version.get(e.config.OLD_IE_CLSID, !0);
                return a ? (c = e.version.compare(a, e.config.OLD_MIN_VER) > 0 ? 1 : 0, !!c) : !1
            }, hasQQLivePlayer: function () {
                if (-1 != b)return 1 == b;
                var a = e.version.get(e.config.LIVEAPI_CLSID);
                return a ? (b = e.version.compare(a, "0.0.0.0") > 0 ? 1 : 0, !!b) : !1
            }, getSupportMinVersion: function () {
                return tvp.$.browser.ie ? e.config.IE_MIN_VER : tvp.$.browser.firefox ? e.config.FF_MIN_VER : tvp.$.browser.webkit ? e.config.CHROME_MIN_VER : "0.0.0.0"
            }
        }
    }(), e.userAgent = e.browser, e.installer = {
        timer: null, installerObj: null, getInstallerHtml: function () {
            var a = "";
            return a += '<div id="qqlive_mminstaller_div"><OBJECT classid="clsid:' + e.config.MMINSTALL_CLSID + '" codebase="http://dl_dir.qq.com/qqtv/MMInstaller.cab#version=' + e.config.MMINSTALL_VER + '" ID="QQLiveInstaller" width="0px" height="0px">', a += '	<embed name="FF_MM_Install" id="FF_MM_Install" type="application/tecent-qqlive-plugin" width="0px" height="0px"></embed>', a += "</OBJECT></div>"
        }, showInstallerObject: function (a) {
            tvp.$.getByID(a).innerHTML = e.installer.getInstallerHtml()
        }, isMMInstalled: function () {
            if (tvp.$.browser.ie)try {
                var a = new ActiveXObject(e.config.PROGID_QQLIVE_INSTALLER);
            ...
            if (b && tvp.$.browser.isNotIESupport()) {
                if (c = document.embeds.FF_MM_Install, !c) {
                    ...
                    d.innerHTML = e.installer.getInstallerHtml(), document.getElementsByTagName("body")[0].appendChild(d), c = document.embeds.FF_MM_Install
                }
                try {
                    c.CreateAX(b)
                } catch (f) {
        ...
        getFullVersion: function () {
            ...
            var a = !1;
            return a = tvp.$.browser.ie ? -1 == e.version.compare(e.flash.getFullVersion(), e.config.IE_FLASH_MIN_VER) ? !1 : !0 : -1 == e.version.compare(e.flash.getFullVersion(), e.config.FF_FLASH_MIN_VER) ? !1 : !0
        }
    }, e.player = {
        startup: function () {
            0 != tvp.$.browser.isCanOcx() && 0 != e.flash.isFlashVerVaild() && 0 != e.version.check(e.config.STARTUP_MIN_VER) && (window.location.href = "qqlive://system_startup/")
        }, openClient: function (a, b) {
            if (a && e.version.hasQQLivePlayer()) {
                var c = "qqlive://sso/";
                if (!b) {
                    var d = a;
                ...
                var f = e.installer.getActiveXObj(e.config.PROGID_QQLIVE_LIVEAPI, "");
                if (f)try {
                    return void f.OpenQQLive(c)
                } catch (g) {
                }
                window.location.href = c
            }
        ...
        rptImg: null, bind: function (a, b) {
            ...
            }) : (e.event.rptImg = new Image, e.event.rptImg.src = "http://pinghot.qq.com/pingd?dm=v.qq.com.hot&url=/virtual/ocx.html&tt=" + escape(document.title) + "&hottag=OCX.SETUP." + a + "&hotx=9999&hoty=9999&rand=" + Math.round(1e5 * Math.random())), tvp.$.cookie.set("lv_ocx_rpt", d | b, document.location.hostname || document.location.hostname))
        }
    };
    var e = e || {};
    e.DEFINE = {
        ...
        function f(c, d) {
            ...
            var g = b.Deferred();
            a[f] = g;
            var h = "//imgcache.qq.com/tencentvideo_v1/tvp/js/", j = c.toLowerCase();
            "OcxPlayer" == c && "undefined" != typeof e && "undefined" != typeof e.DEFINE && (j = "ocxplayerlite");
        ...
        var h = b.now(), i = ["\u672a\u6307\u660e\u64ad\u653e\u5668\u5185\u6838", "\u60a8\u5f53\u524d\u4f7f\u7528\u7684\u7edf\u4e00\u64ad\u653e\u5668JS\u6587\u4ef6\u4e0d\u5305\u542b\u6307\u5b9a\u7684\u64ad\u653e\u5668\u5185\u6838", "video\u672a\u521d\u59cb\u5316"], j = function (c, d) {
            ...
            return c.video.setCurPlayer(d), j.checkLivePlayer = i, b.when(c.type == a.PLAYER_DEFINE.VOD ? e() : i(c.video)).then(function () {
                ...
                c.type == a.PLAYER_DEFINE.VOD && x && d && d.trigger && d.trigger(a.ACTION.onVodH5Init), "function" != typeof a[t] ? f(t, g).done(function () {
                    p.call(d)
                }) : p.call(d)
            }), q
        }, k = {
        ...
        a.Player = function (c, e) {
            ...
            setting: function (a, b) {
                ...
                var g = function () {
                    j(f.config, f).done(function (c, g) {
                        try {
                            d(3, f.sessionId, {
    ...
    }(tvp.$), tvp.filename = "tvp.player_v2_jq.js", "function" == typeof define && define("tvp", [], function () {
        return tvp
    }), a.tvp = tvp, "undefined" != typeof e && (a.QQLive = e)
}(this);